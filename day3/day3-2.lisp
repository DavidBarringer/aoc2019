; a better check for an intersection, past me has been defeated again
(defun check (coord l)
  (if (OR (AND (< (CAAR l) (CAR coord)) (> (CAADR l) (CAR coord)) (= (CDAR l) (CDR coord)))
          (AND (> (CAAR l) (CAR coord)) (< (CAADR l) (CAR coord)) (= (CDAR l) (CDR coord)))
          (AND (> (CDAR l) (CDR coord)) (< (CDADR l) (CDR coord)) (= (CAAR l) (CAR coord)))
          (AND (< (CDAR l) (CDR coord)) (> (CDADR l) (CDR coord)) (= (CAAR l) (CAR coord)))) t Nil))

; gets the distance to an intersection, sums until the check succeeds then returns sum
...
(defun run2 ()
  ...
  (apply `min (mapcar `+
  ; gets list of lengths to intersections for each wire
  (sumlist (checkcrossing (coord (CAR (getWires)) `((0 . 0))) (coord (CADR (getWires)) `((0 . 0))) ())
           (coord (CADR (getWires)) `((0 . 0))) ())
  (sumlist (checkcrossing (coord (CAR (getWires)) `((0 . 0))) (coord (CADR (getWires)) `((0 . 0))) ())
           (coord (CAR (getWires)) `((0 . 0))) ()))))
